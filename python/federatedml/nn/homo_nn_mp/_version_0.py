...
def client_fit(self, data_inst):
    ...
    while self.aggregate_iteration_num + 1 < self.max_aggregate_iteration_num:
        ...
        # LOGGER.info("\n---iter:{}, role:{}, before train weight {}".format(self.aggregate_iteration_num, self.role, self.nn_model.get_model_weights().unboxed))

        # LOGGER.info("\n---iter:{}, role:{}, inverse weight {}".format(self.aggregate_iteration_num, self.role,
        # (self.nn_model.get_model_weights()*-1).unboxed))
        ...
        LOGGER.info("\n---iter:{}, role:{}, before agg weight {}".format(self.aggregate_iteration_num, self.role,
                                                                         self.nn_model.get_model_weights().unboxed))
        ...
        LOGGER.info("\n{}--- after agg weight {}".format(self.aggregate_iteration_num, weights.unboxed))
