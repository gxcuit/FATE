...
homo_nn_cpn_meta = ComponentMeta("HomoNNMP")
...
def homo_nn_runner_client():
    from federatedml.nn.homo_nn_mp.enter_point import HomoNNDefaultClient
...
def homo_nn_runner_arbiter():
    from federatedml.nn.homo_nn_mp.enter_point import HomoNNDefaultServer
